...
function carregarPergunta() {
  ...
  let indiceAleatorio = Math.floor(Math.random() * (perguntasRPGuaxa.fases[nivelPerguntas].questoes.length));

  const perguntaAtual = perguntasRPGuaxa.fases[nivelPerguntas].questoes[indiceAleatorio]; // Pega a pergunta atual
